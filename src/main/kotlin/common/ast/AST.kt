...
data class BinaryOperationNode(val symbol: String, val left: BinaryNode?, val right: BinaryNode?) : BinaryNode //Contiene dos operandos y el símbolo de la operación
